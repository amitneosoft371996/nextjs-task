      ...
      <div className="navbar ">
        ...
        <div className="navbar-end">
          <div className='cartbtnbx'>
            <Link href="/productcartdetails" className='cartbtn'>
          ...
          {isLoggedIn ? (
            ...
            <Link className="logout-btn" href="/login">Login</Link>
          )}
          <span style={{ width: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff', color: '#7fb401', height: '40px', borderRadius: '50px' }}>
